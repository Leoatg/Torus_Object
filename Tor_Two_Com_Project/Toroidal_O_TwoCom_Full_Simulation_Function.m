function     Toroidal_O_TwoCom_Full_Simulation_Function(Pmp,Pse,Psi,M)
...
file_name_parameter=sprintf('m0=%d_Pmp0=%.2f_PmpPL=%.1f_l=%d_p=%d_w0=%d_XYmax=%d_N=%d_T=%d',Psi.Ini_m,Pmp.Pbar0,Pmp.PL,Pmp.l,Pmp.p,Pmp.w0,Pmp.XYmax,N,floor(TotalTime));
...
currentFolder = pwd;
folder_name_parameter=sprintf('XYmax=%d_IR=%.1f_J=%.1f',Pmp.XYmax,IR,J);
