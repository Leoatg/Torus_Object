...
if print_fig~=0 && Record_Mov_m==0
    print(fig_Imomega_max,'-painters','-depsc2','-r350',sprintf('Max_Im_omega_GammaR=%.1f_P1=%.1f_R0=%.1f.eps',GammaR,P1,R0));
    close(fig_Imomega_max);
end
