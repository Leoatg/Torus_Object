...
hold(axis_re,'all');
plot(axis_re,k,real(Eigen_omega_2),'linewidth',2,'color','g');
...
plot(axis_im,k,imag(Eigen_omega_2),'linewidth',2,'color','g');
...
print(gcf,'-painters','-dpng','-r250',sprintf('Dispersion_Curve_m=%d_GammaR=%.1f_P1=%.1f_R0=%.1f.png',m,GammaR,P1,R0));
close(fig_disp);
end
