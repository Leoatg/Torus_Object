...
hold all;
st_legend=sprintf('GammaR=%.1f',GaR_series(1));
for it=2:N_GaR
...
if print_fig~=0
    ...
    %print(fig_m_ds_R0,'-painter','-depsc',resolution,'m_ds_R0_Dependence_GammaR.png');
    print(fig_m_ds_R0,'-painter','-dpng','-r250','m_ds_R0_Dependence_GammaR.png');
...
save(sprintf('m_ds_R0_Dependence_GammaR_P1=%.1f.mat',P1));
