...
Nds=N_P1;
for itt=1:length(P1_series)
    if m_ds_P1(1,itt)==100
        Nds=itt;
        break;
    end
end
...
if print_fig~=0
    ...
    print(fig_m_ds_m_es_P1,'-painter','-depsc','-r250',sprintf('m_ds_m_es_P1_Dependence_GammaR=%.1f_R0=%.1f.eps',GammaR,R0));
