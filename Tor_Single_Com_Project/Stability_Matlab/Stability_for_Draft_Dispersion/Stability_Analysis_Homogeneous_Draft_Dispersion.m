...
for it_P_series=1:3
    ...
    h_a=annotation('textbox', [0.1460    0.750    0.08    0.08],'String',ann_text);
    ...
    set(axis_sub_fig_Re,'xlim',[k_min,k_max]);
    ...
    %set(gca,'fontsize',Font_size,'fontname',Font_name);
    set(axis_sub_fig_Im,'xlim',[k_min,k_max]);
    ...
    set(axis_sub_fig_Im,'yticklabel',num2str(sortrows(y_tick.'),'%.1f'));
