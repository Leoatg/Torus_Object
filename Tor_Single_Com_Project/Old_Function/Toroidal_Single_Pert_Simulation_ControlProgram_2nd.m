...
Simulation_version='Pert_2nd';
component_number=1;

%% Perturbation Parameters
Pert_Strength=1e-2; %will multiply to the steady state mode
%Pert_Fre=-50; %Perturbation density spacial variation frequency  m+Fre, m-Fre
