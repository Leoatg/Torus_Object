...
m0=66; fixed_int_r=1; int_r=XYmax-10;%auto set int_r to 0.95 damping
Ini_kind=2; %torodial initial state

Simulation_version='2nd_Draft_2_A';
component_number=1;
...
%% Full Simulation
  ...
  Toroidal_O_Single_FollowUp_Inco_Function_Draft_2_A(Pmp,Pse,Psi,M);
