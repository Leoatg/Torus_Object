...
Simulation_version='Pert_1st_try_Mk';
global File_name_append;File_name_append='pp';
...
Pert_Fre=0; %Perturbation density spacial variation frequency  m+Fre, m-Fre
...
%Pert_Strength_series=[0.001,0.01,0.05];

for m0=56:-2:46
    %Pert_Strength=Pert_Strength_series(ntt);
