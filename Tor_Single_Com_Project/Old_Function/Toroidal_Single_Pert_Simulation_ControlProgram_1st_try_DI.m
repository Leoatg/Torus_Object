...
Pert_Strength=0.01; %will multiply to the steady state mode
Pert_Fre=17; %Perturbation density spacial variation frequency  m+Fre, m-Fre
...
%% Full Simulation
%try
Toroidal_O_Single_Pert_Simulation_Inco_Function_try(Pmp,Pse,Psi,M);
% catch err
